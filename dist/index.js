...
const parseHelmRepoIndex = (currentRelease, repoIndex) => {
    ...
    const currentVersion = (0, semver_1.valid)(currentRelease.version);
    ...
    repoIndex.entries[chart].forEach((chartVersion) => {
        const version = (0, semver_1.valid)(chartVersion.version);
        if (version) {
            if ((0, semver_1.compareBuild)(version, latestVersion) === 1) {
...
exports.parseHelmRepoIndex = parseHelmRepoIndex;
const checkHelmUpdates = async (currentHelmRelease) => {
...
exports.checkHelmUpdates = checkHelmUpdates;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const helm_1 = __nccwpck_require__(8306);
const stack_1 = __nccwpck_require__(9675);
...
const run = async () => {
    try {
        ...
        Promise.all(currentHelmReleases.map(release => (0, helm_1.checkHelmUpdates)(release))).then((releases) => {
            ...
            switch (writeFormat) {
                case 'js':
                    (0, write_1.writeAsJS)(releases, writeLocation);
                    break;
                case 'none':
                    core.info('Not writting to disk as format is none');
                    break;
                default:
                    core.warning(`Unrecognised option for write_format ${writeFormat}`);
                    break;
            }
        });
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.writeAsJS = void 0;
const fs_1 = __nccwpck_require__(7147);
const core = __importStar(__nccwpck_require__(2186));
const toCamelCase = (str) => str.toLowerCase().replace(/[^a-zA-Z0-9]+(.)/g, (m, chr) => chr.toUpperCase());
const writeAsJS = (updates, location) => {
    ...
    Promise.all(fileData.split('\n').map((line, lineNum) => {
        ...
        (0, fs_1.writeFileSync)(location, newFile, 'utf-8');
    });
};
exports.writeAsJS = writeAsJS;
